...
jsPsych.plugins['survey-image-form'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // display stimulus
    var html = '<img src="'+trial.stimulus+'" id="jspsych-survey-image-html-stimulus" style="';
    ...
    if(trial.preamble !== null){
      html += '<div id="jspsych-survey-html-form-preamble" class="jspsych-html-image-form-preamble">'+trial.preamble+'</div>';
    }
    // start form
